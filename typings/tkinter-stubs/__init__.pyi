...
class Misc:
    ...
    @overload
    def bind_class(
        self, className: str, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = ...
    ) -> None: ...
    @overload
...
ListPosition: TypeAlias = int | Literal["end"]
...
class Listbox(Widget, XView, YView):
    ...
    def get(self, first: int, last: Any | None = ...) -> str: ...
    def index(self, index): ...
    def insert(self, index: ListPosition, *elements: str) -> None: ...
    def nearest(self, y): ...
    def scan_mark(self, x, y): ...
    ...
    select_anchor: Any
    def selection_clear(self, first: int, last: int | Literal["end"] | None = ...) -> None: ...  # type: ignore[override]
    select_clear: Any
    def selection_includes(self, index): ...
    select_includes: Any
    def selection_set(self, first: int | Tuple[int, ...], last: ListPosition | None = ...) -> None: ...
    select_set: Any
    def size(self) -> int: ...
...
class Menu(Widget):
    ...
    def insert_separator(
        self, index: _MenuIndex, cnf: dict[str, Any] | None = ..., *, background: _Color = ...
    ) -> None: ...
...
class Text(Widget, XView, YView):
    ...
    @overload
    def tag_bind(
        self, tagName: str, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = ...
    ) -> None: ...
...
class PhotoImage(Image):
    ...
    def write(
        self, filename: StrOrBytesPath, format: str | None = ..., from_coords: tuple[int, int] | None = ...
    ) -> None: ...
    if sys.version_info >= (3, 8):
