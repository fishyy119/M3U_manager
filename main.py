...
class M3UMManagerApp:
    def __init__(self, root):
        ...
        self.btn_move_up.grid(row=2, column=1, padx=5, pady=10, ipadx=5)  # 上移
        self.btn_move_down.grid(row=2, column=2, padx=5, pady=10, ipadx=5)  # 下移
        self.btn_move_top.grid(row=2, column=3, padx=5, pady=10, ipadx=5)  # 置顶
        self.btn_delete.grid(row=2, column=4, padx=5, pady=10, ipadx=5)  # 删除
